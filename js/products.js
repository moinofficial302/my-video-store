...
onAuthStateChanged(auth,()=>{
  ...
  if(btn1) checkOwnership("editing-pack", btn01);

  const btn2 = document.getElementById("buy-editing-50");
  if(btn2) checkOwnership("editing-pack-50", btn02);
